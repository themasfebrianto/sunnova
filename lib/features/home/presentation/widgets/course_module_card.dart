...
class CourseModuleCard extends StatelessWidget {
  final CourseModuleEntity
  courseModule; // Accept CourseModuleEntity as parameter
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(
              Icons
                  .book, // Placeholder icon, could be dynamic based on module type
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.titleMedium, // Use theme typography
                  ),
                  ...
                  Text(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.bodySmall, // Use theme typography
                  ),
                ],
              ),
            ),
            if (courseModule.isLocked)
              Chip(
                ...
                backgroundColor: Theme.of(
                  context,
                ).colorScheme.error, // Use theme color for error
              ),
          ],
        ),
      ),
